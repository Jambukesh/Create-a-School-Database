...
insert into Student values(1,'Rohit','Sharma',1)
insert into Student values(2,'Shekar','Dhawan',2)
insert into Student values(3,'Virat','Kohli',3)
insert into Student values(4,'Yuvaraj','Singh',4)
insert into Student values(5,'Shuresh','Raina',5)
insert into Student values(6,'Ms','Dhoni',1)
insert into Student values(7,'Hardik','Pandya',3)
insert into Student values(8,'Mohamad','Shami',4)
insert into Student values(9,'Jaspirt','Bumbrah',2)
insert into Student values(10,'Ashish','Nehra',5)
